...
A curated [![Awesome](https://awesome.re/badge-flat.svg)](https://github.com/sindresorhus/awesome) ⭐ 495,052 | 🐛 100 | 📅 2026-06-30 list of falsehoods programmers believe in. A *falsehood* is an ***idea* that you initially believed was true**, but in reality, it is **proven to be false**.
...
* [CLDR currency definitions](https://github.com/unicode-org/cldr/blob/release-40/common/supplemental/supplementalData.xml#L87-L94) ⭐ 1,128 | 🐛 238 | 🌐 Java | 📅 2026-08-13 - 🆓 Currency validity date ranges overlap due to revolts, invasions, new constitutions, and slow planned adoption.
* [Falsehoods about IBANs](https://github.com/globalcitizen/php-iban/blob/master/docs/FALSEHOODS.md) ⭐ 507 | 🐛 6 | 🌐 PHP | 📅 2025-12-03 - International Bank Account Numbers are not international.
* [`tax`](https://github.com/commerceguys/tax) ⭐ 286 | 🐛 11 | 🌐 PHP | 📅 2026-07-13 - 🆓 A PHP 5.4+ tax management library.
...
* [Falsehoods about Bitcoin](https://github.com/theborakompanioni/spring-boot-bitcoin-starter/blob/master/docs/FALSEHOODS.md) ⭐ 85 | 🐛 15 | 🌐 Java | 📅 2026-07-30 - A list of mistaken perspectives on Bitcoin.
...
* [`libvldmail`](https://github.com/dertuxmalwieder/libvldmail) ⭐ 68 | 🐛 1 | 🌐 C | 📅 2026-08-01 - 🆓 A library that implements RFC-based checks for e-mail addresses.
...
* [Big List of Naughty Strings](https://github.com/minimaxir/big-list-of-naughty-strings) ⭐ 47,704 | 🐛 108 | 🌐 Python | 📅 2024-04-18 - 🆓 A huge corpus of strings which have a high probability of causing issues when used as user-input data. A must have set of practical edge-cases to test your software against.
...
* [Falsehoods about Phone Numbers](https://github.com/google/libphonenumber/blob/master/FALSEHOODS.md) ⭐ 18,198 | 🐛 115 | 🌐 C++ | 📅 2026-08-01 - Covers phone numbers, their representation and meaning.
* [`libphonenumber`](https://github.com/google/libphonenumber) ⭐ 18,198 | 🐛 115 | 🌐 C++ | 📅 2026-08-01 - 🆓 Google's common Java, C++ and JavaScript library for parsing, formatting, and validating international phone numbers. Also available for [C#](https://github.com/twcclegg/libphonenumber-csharp) ⭐ 918 | 🐛 7 | 🌐 C# | 📅 2026-08-11, [Objective-C](https://github.com/iziz/libPhoneNumber-iOS) ⭐ 2,384 | 🐛 0 | 🌐 Objective-C | 📅 2026-08-04, [Python](https://github.com/daviddrysdale/python-phonenumbers) ⭐ 3,765 | 🐛 11 | 🌐 Python | 📅 2026-08-01 and [PHP](https://github.com/giggsey/libphonenumber-for-php) ⭐ 5,049 | 🐛 2 | 🌐 PHP | 📅 2026-08-03.

## Postal Addresses

* [`addressing`](https://github.com/commerceguys/addressing) ⭐ 967 | 🐛 20 | 🌐 PHP | 📅 2026-04-15 - 🆓 A PHP 5.4+ addressing library, powered by Google's dataset.
...
* [`address`](https://github.com/Boostport/address) ⭐ 96 | 🐛 0 | 🌐 Go | 📅 2026-07-23 - 🆓 Go library to validate and format addresses using Google's dataset.
...
* [Falsehoods about Fonts](https://github.com/RoelN/Font-Falsehoods) ⭐ 111 | 🐛 5 | 📅 2018-01-23 - Assumptions about typography on the web and in desktop applications.
...
Your contributions are always welcome! Please take a look at the [contribution guidelines](https://github.com/kdeldycke/awesome-falsehood/blob/main/.github/contributing.md) ⭐ 27,611 | 🐛 4 | 📅 2026-08-10 first.

## Footnotes

This list gathered some popularity in social medias over the past few years. See it being [discussed and mentioned elsewhere](https://github.com/kdeldycke/kdeldycke/blob/main/in-the-media.md) ⭐ 9 | 🐛 3 | 📅 2026-08-10.

The [header image](https://github.com/kdeldycke/awesome-falsehood/blob/main/assets/awesome-falsehood-header.jpg) ⭐ 27,611 | 🐛 4 | 📅 2026-08-10 is based on a modified [photo taken in February 2010 by Iza Bella](https://commons.wikimedia.org/wiki/File:BLW_Truth_and_Falsehood.jpg), distributed under a [Creative Commons BY-SA 2.0 UK license](https://creativecommons.org/licenses/by-sa/2.0/uk/deed.en).
